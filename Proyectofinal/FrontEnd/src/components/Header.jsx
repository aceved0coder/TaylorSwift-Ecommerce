...
export const Header = () => {
    ...
    return(
        <div className='w-full p-5 bg-[pink]'>
                ...
                <div className='flex gap-4 items-center justify-center text-white'>
                {
                    ...
                    <div className='flex gap-5'>
                        <Link to="/cart" className='flex flex-col items-center gap-2 text-white group'>
                            <FiShoppingCart className='text-2xl group-hover:fill-blue group-hover:text-pink-500 transition-all'></FiShoppingCart>
                            <span className='hidden lg:block'>Cart</span>
                        </Link>
                        <Link to="/account" className='flex flex-col items-center gap-2 text-white group'>
                            <FiUser className='text-2xl group-hover:fill-blue group-hover:text-pink-500 transition-all'></FiUser>
                            <span className='hidden lg:block'>Account</span>
                        </Link>
                        <button onClick={handleLogout} className='flex flex-col items-center gap-2 text-white group'>
                            <FiLogOut className='text-2xl group-hover:fill-blue group-hover:text-pink-500 transition-all'></FiLogOut>
